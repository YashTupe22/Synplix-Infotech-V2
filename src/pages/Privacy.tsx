  ...
  <Layout variant="dark">
    <div className="bg-black text-white min-h-screen">
      <section className="container pt-40 pb-16">
        ...
        <p className="text-white/60 max-w-2xl">This policy describes how Synplix Infotech Services collects, uses and protects information about visitors and clients.</p>
      </section>
