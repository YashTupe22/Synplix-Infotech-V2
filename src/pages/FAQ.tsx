    ...
    <Layout variant="dark">
      <div className="bg-black text-white min-h-screen">
        <section className="container pt-40 pb-16">
          <p className="text-xs uppercase tracking-[0.2em] text-white/40 mb-6">FAQ</p>
            ...
            {faqs.map((f, i) => {
              ...
              return (
                <div key={f.q} className="border-b border-white/10">
                  ...
                  >
                    <span className="text-lg md:text-2xl font-medium tracking-tight group-hover:text-white/80 transition-colors">
                      {f.q}
                    </span>
                    <span
        ...
        <section className="container pb-32">
          ...
          >
            <div>
              ...
              <p className="text-white/60">Email us — we usually reply the same working day.</p>
            </div>
            <Link
              to="/contact"
